...
const initSpeciality = [
    'General Physician', 'Dentist', 'Pediatrician', 'Gynecologist/Obstetrician', 'Dermatologist', 'Ear-Nose-Throat (ENT) Specialist', 'Cardiologist', 'Endocrinologist', 'Oncologist', 'Physical Therapist', 'Homeopath'
]
