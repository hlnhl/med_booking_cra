...
const initSpeciality = [
    'General Physician', 'Cardiologist', 'Dermatologist', 'Ear-Nose-Throat (ENT) Specialist', 'Endocrinologist', 'Gynecologist/Obstetrician', 'Oncologist', 'Pediatrician', 'Physical Therapist'
]
